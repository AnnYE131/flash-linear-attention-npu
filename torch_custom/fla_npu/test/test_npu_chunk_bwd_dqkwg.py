...
if __name__ == "__main__":
    ...
    h_npu = (h.squeeze(0) if cu_seqlens is not None else h).contiguous().to(dtype).npu()
    ...
    dh_npu = (dh.squeeze(0) if cu_seqlens is not None else dh).contiguous().to(dtype).npu()
